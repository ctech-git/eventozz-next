...
import { AvailableTicketsContainerLeaders } from '../../components/AvailableTicketsContainerLeaders';
import { CheckoutLeaders } from '../../components/CheckoutLeaders';
  ...
  return (
    <>
      ...
      <div className='app-container'>
        ...
        {
          showCheckout ? (
            <CheckoutLeaders dados={event} cartItems={cartItems} handleChangeTicketQuantity={handleChangeTicketQuantity}
