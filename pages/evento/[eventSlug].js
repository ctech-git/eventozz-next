...
const Event = ({ event, isActive, showEventSoon, showTicketSale, showClosedSales, eventDate }) => {
  ...
  return (
    <>
      <Head>
        <title>{`Eventozz | ${event.nome_evento}`}</title>
        <meta name="viewport" content="initial-scale=1.0, width=device-width" />
        <meta name="description" content={event.nome_evento} />
        <meta property="og:type" content="website" />
        <meta property="og:title" content={`Eventozz | ${event.nome_evento}`} />
        <meta property="og:description" content={event.nome_evento} />
